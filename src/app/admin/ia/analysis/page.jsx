...
export default function AnalysisPage() {
    ...
    useEffect(() => {
        (async () => {
            try {
                const res = await fetch("/api/admin/ia/analysis", { cache: "no-store" });
        ...
        <div className="space-y-10">
            ...
            <section className="space-y-2">
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white/80 space-y-1">
                    ...
                    <p>
                        <span className="font-semibold">19:30 - 19:45</span> · Break — coffee
                        + networking.
                    </p>
                    <p>
            ...
            <section className="bg-white/5 border border-cyan-400/30 rounded-xl px-5 py-4">
                ...
                <p className="text-sm text-white/80 leading-relaxed">
                    ...
                    y <span className="font-semibold">{stats.totalRoles} tipos de rol</span>
