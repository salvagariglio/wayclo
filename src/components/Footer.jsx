...
export default function Footer() {
    ...
    return (
        <footer className={["py-4", baseBg, borderClass].join(" ")}>

            {/* INFO EVENTO (solo home / agenda) */}
            {showEventInfo && (
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-8">
                    <h2 className="text-lg font-semibold text-center mb-4 tracking-tight">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 items-start">
                        ...
                        <div>
                            <iframe
                                className="w-full h-48 rounded-lg shadow border border-white/10"
                                loading="lazy"
                                allowFullScreen
                        ...
                        {/* CONTACTO */}
                        <div className="flex flex-col justify-center space-y-3 text-sm text-center md:text-left">
                            <div>
                                <h3 className="font-bold text-base mb-1">Lugar</h3>
